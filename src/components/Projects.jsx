    ...
    <div className="w-full h-full">
      <div className="px-16 py-10  my-10 mx-24 grid grid-cols-2 justify-center items-center gap-10 font-mono">
        ...
        <div className="grid justify-center items-center gap-4">
          ...
          <div className="flex gap-4 w-full justify-center items-center">
          <a href="https://foodisphere.vercel.app/" target="_blank" rel="noopener noreferrer" className="btn btn-primary w-1/4">
  Live
</a>            <button className="btn btn-secondary w-1/4">&lt;Source/&gt;</button>
          </div>
        </div>
        <div className="grid justify-center items-center gap-4">
          <div className="transition-all transform hover:scale-105 duration-700">
          ...
          <div className="flex gap-4 w-full justify-center items-center">
          <a href="https://portfolio-dusky-sigma-50.vercel.app/" target="_blank" rel="noopener noreferrer" className="btn btn-primary w-1/4">
  Live
</a>            <button className="btn btn-secondary w-1/4">&lt;Source/&gt;</button>
          </div>
        </div>
